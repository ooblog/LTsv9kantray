...
def LTsv_kbdreset(LTsv_tsvpath):
    ...
    if len(keyboard_mapdic_page) > 0:
        ...
        keyboard_kanmapT=LTsv_loadfile(LTsv_readlinerest(keyboard_mapdic_page,"mapname"))
        ...
        LTsv_keyboard_kandic=LTsv_loadfile(LTsv_readlinerest(keyboard_mapdic_page,"dicname"),LTsv_keyboard_kandic)
